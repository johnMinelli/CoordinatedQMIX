...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lr_niter_frozen', type=int, default=50000, help='[lr_policy=lambda] # of iter at starting learning rate')
        self.parser.add_argument('--lr_niter_decay', type=int, default=1500, help='[lr_policy=lambda] # of iter to linearly decay learning rate to zero')
