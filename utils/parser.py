...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--env', default='pursuit', choices=['pursuit', 'switch', 'checkers'], help='Name of the environment (default: %(default)s)')
        ...
        self.parser.add_argument('--agent', type=str, required=False, default="idqn", help='Label of a trained solver agent to be loaded from `load_path` (default %(default)s). -1 to load the last saved model in the folder.')
        ...
        self.parser.add_argument('-ep', '--episodes', type=positive_int, default=600, required=False, help='The episodes to run the training procedure (default %(default)s).')
        self.parser.add_argument('-vep', '--val_episodes', type=positive_int, default=3, required=False, help='The episodes to run the validation procedure (default %(default)s).')
        self.parser.add_argument('-bs', '--batch_size', type=positive_int, default=32, required=False, help='The batch size to be sampled from the memory for the training (default %(default)s).')
        self.parser.add_argument('-k', '--K_epochs', type=positive_int, default=1, required=False, help='The number of epochs to run on the single batch (default %(default)s).')
        self.parser.add_argument('-ck', '--chunk_size', type=positive_int, default=15, required=False, help='The number of epochs to run on the single batch (default %(default)s).')
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--min_epsilon', type=positive_float, default=0.20, required=False, help='The discount factor of PPO advantage (default %(default)s).')
        self.parser.add_argument('--max_epsilon', type=positive_float, default=0.90, required=False, help='The discount factor of PPO advantage (default %(default)s).')
