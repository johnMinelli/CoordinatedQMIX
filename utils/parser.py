...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--env', default='pursuit', choices=["pursuit, Switch4-v0"], help='Name of the environment (default: %(default)s)')
        ...
        self.parser.add_argument('-vep', '--val_episodes', type=positive_int, default=5, required=False, help='The episodes to run the validation procedure (default %(default)s).')
        ...
        self.parser.add_argument('--shared_multiagent', required=False, action='store_true', help='Control each actor with a different agent.')
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('-pf', '--print_freq', type=int, default=1, help='Frequency of showing training results on console')
        ...
        self.parser.add_argument('--lr_niter_frozen', type=int, default=25, help='[lr_policy=lambda] # of iter at starting learning rate')
