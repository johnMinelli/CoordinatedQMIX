...
class RolloutStorage(object):
    ...
    '''
    def __init__(self, size, n_processes, num_dummy, obs_space, action_space, comm_size):
        ...
        self.masks = torch.zeros(size, n_processes, num_dummy, 1)
    ...
    def sample_chunk(self, batch_size, chunk_size):
        ...
        for start_ind in perm:
            end_ind = start_ind + chunk_size+1
            if len(obs_batch) == batch_size: break
            if self._step > start_ind and self._step < end_ind: continue
